...
st.caption("Análisis de glosa · defensa de la IPS · revisión humana · previsualización · PDF institucional + anexos")
...
source_type = st.radio("¿Cómo tienes la glosa?", ["Cargar PDF", "Pegar o escribir texto"], horizontal=True)
...
if "analysis" in st.session_state:
    ...
    st.caption("Gemini propone; tú decides. La aplicación no radica nada automáticamente.")
    ...
    st.subheader("5. Previsualización del documento")
    ...
    if st.session_state.get("preview_pdf"):
        ...
        st.divider()
        st.subheader("6. Generar PDF final + anexos")
